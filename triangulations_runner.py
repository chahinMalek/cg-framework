...
_12gon = Polygon([Point(1, 1), Point(6, 4), Point(3, 0), Point(4, 8),
                  Point(5, 1), Point(0, 3), Point(6, 3), Point(5, 6),
                  Point(1, 7), Point(3, 9), Point(2, 9), Point(0, 5)])
...
print("{}: {}".format(len(_12gon.points), len(all_triangulations(_12gon))))
