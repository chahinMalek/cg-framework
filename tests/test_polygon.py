...
def test_orientation() -> None:
    ...
    """
    polygon_1 = Polygon([Point(1,1), Point(5,6), Point(5,3), Point(2,5), Point(4,8), Point(2,3), Point(4,1), Point(3,4)])
    polygon_2 = Polygon([Point(1,1), Point(2,3), Point(2,5), Point(5,3), Point(4,8), Point(5,6), Point(4,1), Point(3,4)])
...
def test_make_simple() -> None:
    ...
    """
    polygon_1 = Polygon([Point(1,1), Point(5,6), Point(5,3), Point(2,5), Point(4,8), Point(2,3), Point(4,1), Point(3,4)])
    simple = Polygon([Point(4,1), Point(5,3), Point(5,6), Point(3,4), Point(2,3), Point(4,8), Point(2,5), Point(1,1)])
...
def test_make_convex() -> None:
    ...
    """
    polygon = Polygon([Point(1,1), Point(5,6), Point(5,3), Point(2,5), Point(4,8), Point(2,3), Point(4,1), Point(3,4)])
    convex = Polygon([Point(1,1), Point(4,1), Point(5,3), Point(5,6), Point(4,8), Point(2,5)])
...
def test_does_contain() -> None:
    """
        Tests if Polygon class method does_contain works correctly. Two common and one edge case.
    """
    polygon = Polygon([Point(1,1), Point(5,6), Point(5,3), Point(2,5), Point(4,8), Point(2,3), Point(4,1), Point(3,4)])
    point_in = Point(4, 4)
    point_out = Point(0, 0)
...
def test_number_of_intersections() -> None:
    ...
    """
    line_segment_intersect = LineSegment(first=Point(0, 0), second=Point(10, 10))
    line_segment_no_intersect = LineSegment(first=Point(0, 0), second=Point(-10, -10))
    polygon = Polygon([Point(1,1), Point(5,6), Point(5,3), Point(2,5), Point(4,8), Point(2,3), Point(4,1), Point(3,4)])
    assert polygon.number_of_intersections(line_segment_intersect) == (6, False)
    assert polygon.number_of_intersections(line_segment_no_intersect) == (0, False)

def test_does_intersect() -> None:
    """
        Tests if Polygon class method does_intersect works correctly. Two common and one edge case.
    """
    polygon = Polygon([Point(1,1), Point(5,6), Point(5,3), Point(2,5), Point(4,8), Point(2,3), Point(4,1), Point(3,4)])
...
def test_is_empty() -> None:
    """
        Tests if Polygon class method is_empty works correctly. Two common and one edge case.
    """
    polygon = Polygon([Point(1,1), Point(5,6), Point(5,3), Point(2,5), Point(4,8), Point(2,3), Point(4,1), Point(3,4)])
    no_points = []
...
def test_is_convex() -> None:
    ...
    """
    polygon = Polygon([Point(1,1), Point(5,6), Point(5,3), Point(2,5), Point(4,8), Point(2,3), Point(4,1), Point(3,4)])
    convex = Polygon([Point(1,1), Point(3,3), Point(0,5), Point(-1, 4), Point(-1,2)])
